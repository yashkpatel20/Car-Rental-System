...
if(isset($_POST['review_form'])) {
    ...
    $ins_query = "INSERT INTO `rating_review`(`booking_id`, `car_id`, `user_id`, `rating`, `review`) VALUES (?, ?, ?, ?, ?)";

    $ins_values = [ $frm_data['booking_id'], $frm_data['car_id'], $_SESSION['uId'], $frm_data['rating'], $frm_data['review']];
