...
define('INDUSTRY_TYPE_ID', 'Retail'); //Change this constant's value with default industry type id
define('CHANNEL_ID', 'WEB'); // Change this constant's value with default channel id

define('CALLBACK_URL', 'http://localhost/CRS/pay_response.php'); //Change this constant's value with Callback url
